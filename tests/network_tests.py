...
class NetworkTestCase(unittest.TestCase):
    ...
    def test_zero(self):
        ...
        result = self.Network.multiply(0)
    ...
    def test_natural_number(self):
        ...
        result = self.Network.multiply(5)
    ...
    def test_integer_number(self):
        ...
        result = self.Network.multiply(-7)
    ...
    def test_rational_number(self):
        ...
        result = self.Network.multiply(6/17)
    ...
    def test_real_number(self):
        ...
        result = self.Network.multiply(math.pi)
